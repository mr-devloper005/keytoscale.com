...
const inputClass = 'h-12 rounded-2xl border border-[rgba(16,37,63,0.12)] bg-white/90 px-4 text-base font-bold text-[var(--slot4-page-text)] outline-none transition placeholder:text-[var(--slot4-soft-muted-text)] focus:border-[var(--slot4-accent)] focus:bg-white focus:ring-4 focus:ring-[rgba(42,141,228,0.1)]'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-full bg-[var(--slot4-dark-bg)] px-6 text-sm font-black uppercase tracking-[0.18em] text-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-[0_16px_35px_rgba(16,37,63,0.22)] disabled:opacity-60'
